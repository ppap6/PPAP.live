  ...
  <div class="comment-detail">
    <div class="answer-detail">
      ...
      <div class="requestor">
        ...
        <div class="right">
          <router-link class="user-name" :to="`/user/${answer_detail.requestor_id}`">
            <span class="uname">{{answer_detail.requestor_name}}</span>
            <img class="auth-title" src="~common/img/auth_title.png" alt="" v-if="answer_detail.requestor_title">
            <img class="auth-role" src="~common/img/auth_role.png" alt="" v-if="answer_detail.requestor_role_id != 5">
          </router-link>
