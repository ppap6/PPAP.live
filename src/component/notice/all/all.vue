<template>
  <div class="all-list">
    ...
    <template v-for="item in noticeList">
      <!-- 评论消息 -->
      <div class="notice" v-if="item.type === 1" :key="item.id">
        <div class="left">
      ...
      <!-- 回复消息 -->
      <div class="notice" v-if="item.type === 2" :key="item.id">
        <div class="left">
          <router-link :to="`/user/${item.id}`">
            <img class="avatar" :src="item.avatar" alt>
            <p class="name">{{item.name}}</p>
      ...
      <!-- 关注消息 -->
      <div class="notice" v-if="item.type === 3" :key="item.id">
        <div class="left">
          <router-link :to="`/user/${item.id}`">
            <img class="avatar" :src="item.avatar" alt>
            <p class="name">{{item.name}}</p>
      ...
      <!-- 点赞消息 -->
      <div class="notice" v-if="item.type === 4" :key="item.id">
        <div class="left">
          <router-link :to="`/user/${item.id}`">
            <img class="avatar" :src="item.avatar" alt>
            <p class="name">{{item.name}}</p>
